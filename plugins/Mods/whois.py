...
from plugins.functions.extract_user import extract_user
from plugins.functions.cust_p_filters import f_onw_fliter
from plugins.functions.last_online_hlpr import last_online
...
async def who_is(client, message):
    ...
    if from_user is None:
        await status_message.edit("ɴᴏ ᴠᴀʟɪᴅ user_id / ᴍᴇꜱꜱᴀɢᴇ ꜱᴩᴇᴄɪꜰɪᴇᴅ")
        return
