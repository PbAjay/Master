...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('✨ ᴜᴩᴅᴀᴛᴇ ✨', url='https://t.me/+cmbBkg_CbqM3ODZl')
        ], [
            InlineKeyboardButton('💠 ʜᴇʟᴩ 💠', callback_data='help2'),
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.edit_message_media(
            InputMediaPhoto(random.choice(PICS), script.MULTIFEATURE_TXT, enums.ParseMode.HTML),
            reply_markup=reply_markup,            
        )
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.edit_message_media(
            InputMediaPhoto(random.choice(PICS), script.MU2_TXT, enums.ParseMode.HTML),
            reply_markup=reply_markup,            
        )
        ...
        if query.from_user.id in ADMINS:
            await query.edit_message_media(
                InputMediaPhoto(random.choice(PICS), script.ADMIN_TXT, enums.ParseMode.HTML), reply_markup=reply_markup)
        else:
